...
public class JailUtil extends Cmd {
	...
	public JailUtil() {
		super("jutil", Permissions.JAIL_OTHER);
	}
	...
	public void run(CommandSender sender, String[] args) throws Exception {
		...
		if (args.length == 1 && args[0].equalsIgnoreCase("set") && sender.hasPermission(Permissions.JAIL_OTHER)) {
		...
		} else if (args.length == 2 && args[0].equalsIgnoreCase("set") && sender.hasPermission(Permissions.JAIL_OTHER)) {
		...
		} else if (args.length == 1 && (args[0].equalsIgnoreCase("delete") || args[0].equalsIgnoreCase("del")) && sender.hasPermission(Permissions.JAIL_OTHER)) {
		...
		} else if (args.length == 2 && (args[0].equalsIgnoreCase("delete") || args[0].equalsIgnoreCase("del")) && sender.hasPermission(Permissions.JAIL_OTHER)) {
			if (j.getConfig().getConfigurationSection("jail") != null) {
